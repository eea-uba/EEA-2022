...
Para ejemplificar el impacto de las priors comparemos los resultados de especificar una distribución prior "adecuada" y otra "inadecuada". En ambos casos vamos a estar una distribución normal.
...
Mientras que en el caso de la prior inadecuada vemos cambios importantes no solo en la distribución a posteriori del parámetro $\beta_1$ sino también para $\beta_0$ y $\sigma$
