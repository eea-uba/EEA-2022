...
4) **Residual** vs **leverage**: Considerando el criterio que una observación es potencialmente influyente cuando $h_{ii}>0.5$ concluimos que que existen tres puntos con un leverage bastante alto. De ellas, el gráfico destaca la observación 97
