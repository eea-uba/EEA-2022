...
author: "Juan Barriola y Sofía Perini ^[Basado en la [clase](https://diegokoz.github.io/EEA2019/clase%201/Clase%201-%20Introduccion.nb.html) de Juan Barriola y Diego Kozlowski]"
...
![https://cran.r-project.org/](Rlogo.png){width=100}
...
![Fuente: https://gist.github.com/daroczig/3cf06d6db4be2bbe3368](number-of-submitted-packages-to-CRAN.png){width=1000}


![https://www.rstudio.com/](RStudiologo.png){width=200}
...
![Pantalla Rstudio](Pantalla Rstudio.png){width=1000}
...
![logo Rpoject](Rproject.png){width=100}
