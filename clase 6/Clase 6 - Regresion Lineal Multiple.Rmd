...
* Vemos que el nivel medio del precio es una función lineal de la superficie de la propiedad, con una misma pendiente $\beta_{surface\_covered}$ `r round(tidy_sc_pt$estimate[2])` para casas, departamentos y PHs. 
